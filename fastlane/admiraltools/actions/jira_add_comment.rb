...
module Fastlane
  module Actions
    class JiraAddCommentAction < Action
      def self.run(params)
        ...
        jira_client.add_comment(params: params)

        UI.message('Comment action finished successfully 🎉')
      end
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :issue,
                                       description: 'JIRA issue name or id',
                                       optional: false,
                                       type: String),
          FastlaneCore::ConfigItem.new(key: :comment_body,
                                       description: 'JIRA comment message body',
                                       optional: false,
                                       type: String),
