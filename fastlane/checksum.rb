...
def set_checksum(admiral_swiftui_checksum:, admiral_theme_checksum:, admiral_resources_checksum:, admiral_uikit_checksum:, admiral_symbols_checksum:, admiral_images_checksum:)
