...
/// This is the configuration object for a view controller that will be presented using the PanModal transition.
public protocol BottomSheetPresentable: AnyObject {
    ...
    /// The height of the pan modal container view  when in the shortForm presentation state.
    /// This value is capped to .max, if provided value exceeds the space available.
     
    /// Default value is the longFormHeight.
    var shortFormHeight: BottomSheetHeight { get }
    
    /// The height of the pan modal container view when in the longForm presentation state.
    /// This value is capped to .max, if provided value exceeds the space available.
     
    /// Default value is .max.
    var longFormHeight: BottomSheetHeight { get }
    
    /// The corner radius of pan modal
    ...
    /// We configure the panScrollable's scrollIndicatorInsets interally so override this value  to set custom insets.
