...
public struct SecondaryTitleListView: View, CenterListViewComponent {
    ...
    public init(
        title: String?,
        lineLimit: Int? = nil,
        schemeProvider: SchemeProvider<SecondaryTitleListViewScheme> = AppThemeSchemeProvider<SecondaryTitleListViewScheme>()
    ) {
