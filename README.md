...
If you want to know more about the status of the components in the `AdmiralUI` design system, please follow this [link](https://github.com/admiral-team/admiralui-ios/blob/develop/Documentation/info/documentation.pdf)
