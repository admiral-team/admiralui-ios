...
#ifndef ADMIRALSWIFTUI_SWIFT_H
#define ADMIRALSWIFTUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdmiralSwiftUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
/// <h2>Example to create BlocFormatter in StandardTextField</h2>
/// <h1>Code</h1>
/// \code
/// StandardTextField(
///     value: .constant("Text"),
...
///
/// \endcode
SWIFT_CLASS("_TtC14AdmiralSwiftUI13BlocFormatter")
@interface BlocFormatter : NSFormatter
