//
//  IconsFlagsCurrencyViewController.swift
//  ExampleiOS
//
...
final class IconsFlagsCurrencyViewController: UIViewController, AnyAppThemable {

    // MARK: - Private Properties

    private let themeSwitchView = ThemeSwitchView(frame: .zero)
    private let viewModel = IconsFlagsCurrencyViewModel()
    ...
    func apply(theme: AppTheme) {
        ...
        stackView.arrangedSubviews.forEach { ($0 as? AppThemeCompatible)?.apply(theme: theme) }
