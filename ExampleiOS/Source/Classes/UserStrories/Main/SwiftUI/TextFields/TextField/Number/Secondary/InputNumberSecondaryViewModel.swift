//
//  InputNumberSecondaryViewModel.swift
//  ExampleiOS
//
...
@available(iOS 13.0, *)
final class InputNumberSecondaryViewModel: ObservableObject {

    struct InputNumberSecondaryItem: Identifiable {
    ...
    @Published var items: [InputNumberSecondaryItem]
