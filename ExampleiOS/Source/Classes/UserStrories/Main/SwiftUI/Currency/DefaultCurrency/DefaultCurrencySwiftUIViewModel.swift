//
//  DefaultCurrencySwiftUIViewModel.swift
//  ExampleiOS
//
...
final class DefaultCurrencySwiftUIViewModel: ObservableObject {
    ...
    init() {
        ...
        items = [
            .init(currencyText: "USD", buyText: "68,65", sellText: "67,88"),
            .init(currencyText: "EUR", buyText: "68,65", sellText: "67,88"),
            .init(currencyText: "GBP", buyText: "68,65", sellText: "67,88"),
            .init(currencyText: "CNY", buyText: "68,65", sellText: "67,88")
        ]
    }
