//
//  DefaultCurrencySwiftUIView.swift
//  ExampleiOS
//
        ...
        NavigationContentView(navigationTitle: "Default") {
            ...
            VStack(alignment: .leading) {
                ...
                VStack(alignment: .leading, spacing: 0.0, content: {
                    ...
                    CurrencyView(currencyText: "EUR", buyText: "168,65", sellText: "167,88")
                        .frame(height: LayoutGrid.halfModule * 10)
                    CurrencyView(currencyText: "GBP", buyText: "18,65", sellText: "18,88")
                        .frame(height: LayoutGrid.halfModule * 10)
                    CurrencyView(currencyText: "CNY", buyText: "0,65", sellText: "0,88")
                        .frame(height: LayoutGrid.halfModule * 10)
                })
