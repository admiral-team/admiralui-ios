//
//  TrailingComponentsSwiftUIViewModel.swift
//  ExampleiOS
//
...
final class TrailingComponentsSwiftUIViewModel: ObservableObject {
    ...
    init() {
        items = [
            ...
            .init(type: .badgeArrowListView),
            .init(type: .subtitleImageArrowListView),
            .init(type: .tagControl)
        ]
    }
