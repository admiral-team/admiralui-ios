...
internal class ColorMapView: UIView {
    ...
    private static func createColorMapImage(size: CGSize, model: HRColorMapModel) -> CGImage? {
        ...
        case .extendedSRGB:
            colorSpace = CGColorSpace(name: CGColorSpace.displayP3) !! fatalError("")
        case .sRGB:
            colorSpace = CGColorSpace(name: CGColorSpace.sRGB) !! fatalError("")
        }
        ...
        return CGImage(
            ...
            space: colorSpace, bitmapInfo: [], provider: dataProvider !! fatalError(""),
